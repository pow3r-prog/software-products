...
<td><?= $result_log[9]?></td>
<td><?= $result_log[10]?></td>
<td><a id="button2" href="update3.php?id=<?= $result_log[0]?>">UPDATE</a></td>
<td><a id="button2" href="scripts/delete3.php?id=<?= $result_log[0]?>">DELETE</a></td>
...
<form action="scripts/create3.php" method="post">
<p>OPERATOR</p>
