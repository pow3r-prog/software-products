...
$element_id = $_GET['id'];
$element = mysqli_query($link, "SELECT * FROM `sql_ddl` WHERE `id` = '$element_id'");
...
<form action="scripts/update4.php" method="post">
<input type="hidden" name="id" value="<?= $element['id'] ?>">
<p>COMMAND</p>
<input type="text" name="command" value="<?= $element['command'] ?>">
<p>DESCRIPTION</p>
