...
<br>
<br>
<h1>sql_arithmetic_operators</h1>
<table class="table">
...
<td><?= $result_ar[2]?></td>
<td><?= $result_ar[3]?></td>
<td><a id="button2" href="update.php?id=<?= $result_ar[0]?>">UPDATE</a></td>
<td><a id="button2" href="scripts/delete.php?id=<?= $result_ar[0]?>">DELETE</a></td>
</tr>
<?php
}
?>
